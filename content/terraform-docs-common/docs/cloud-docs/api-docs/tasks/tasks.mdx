...
| `data.attributes.global-configuration.stages`            | array  |         | (Optional) An array of strings representing the stages of the run lifecycle when the task should begin. Must be one or more of `"pre_plan"`, `"post_plan"`, `"pre_apply"`, or `"post_apply"`. |
| `data.attributes.global-configuration.enforcement-level` | string |         | (Optional) The enforcement level of the task. Must be `"advisory"` or `"mandatory"`.                                                                                                    |
...
| `data.attributes.global-configuration.stages`            | array  | (previous value) | (Optional) An array of strings representing the stages of the run lifecycle when the task should begin. Must be one or more of `"pre_plan"`, `"post_plan"`, `"pre_apply"`, or `"post_apply"`. |
| `data.attributes.global-configuration.enforcement-level` | string | (previous value) | (Optional) The enforcement level of the task. Must be `"advisory"` or `"mandatory"`.                                                                                                    |
